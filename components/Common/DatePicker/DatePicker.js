...
import ClearIcon from "@/public/icons/clear-icon.svg";
import ScheduleTestIcon from "@/public/icons/schedule-test.svg";
...
const DatePicker = ({
    ...
    const pickerDate = [ "time", "date", "month", "year", "timeShort", "week" ].includes(picker)
        ? picker
        : undefined;
    ...
    return (
        <Picker
            ...
            dropdownClassName={classNames(
                ...
                dropdownClassName,
                FONT_FAMILY.className,
            )}
            superPrevIcon={
                <span className={classNames(styles.superIcon, styles.superPrevIcon)}></span>
            }
            superNextIcon={
                <span className={classNames(styles.superIcon, styles.superNextIcon)}></span>
            }
